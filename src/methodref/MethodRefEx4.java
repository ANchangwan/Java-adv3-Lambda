...
public class MethodRefEx4 {
    public static void main(String[] args) {
        ...
        // 메서드 참조, 타입이 첫 번째 매개변수가 됨. 그리고 첫번재 매개변수의 메서드를 호출
        // 나머지는 순서대로 매개변수에 전달
        System.out.println("person.upperName = " + fun1.apply(person, 12));
        System.out.println("person.upperName = " + fun2.apply(person, 12));
