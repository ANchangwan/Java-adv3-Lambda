...
public class MethodRef4 {
    public static void main(String[] args) {
        ...
        List<String> resultUpper1 = mapStringToString(result1, (String s) -> s.toUpperCase());
        List<String> resultUpper2 = mapStringToString(result1, String::toUpperCase);
        System.out.println("resultUpper1: " + resultUpper1);
        System.out.println("resultUpper2: "+ resultUpper2);
